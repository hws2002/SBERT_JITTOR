"""
Evaluate a trained SBERTJittor checkpoint on STS-style datasets.

Supports: STS12-16, STS-B, SICK-R
"""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate a trained SBERTJittor checkpoint on STS datasets",
